# MullvadVpn TypeScript SDK Reference

Complete API reference for the MullvadVpn TypeScript SDK.
...
```ts
new MullvadVpnSDK(options?: object)
```
...
#### `MullvadVpnSDK.test(testopts?, sdkopts?)`
...
**Returns:** `MullvadVpnSDK` instance in test mode.
...
| --- | --- | --- | --- |
| `blacklisted` | `Record<string, any>` | No |  |
| `city` | `string` | No |  |
| `country` | `string` | No |  |
| `ip` | `string` | No |  |
| `latitude` | `number` | No |  |
...
Return the parent `MullvadVpnSDK` instance.
