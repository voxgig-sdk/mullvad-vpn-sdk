...
func registerSDKWords(r *eng.Registry, client *sdk.MullvadVpnSDK) {
...
func runOp(client *sdk.MullvadVpnSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
