# MullvadVpn SDK IpInformation entity
...
class IpInformationEntity
  ...
  def data_set(args)
    if args
      @_data = MullvadVpnHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = MullvadVpnHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [IpInformation, Hash] the loaded IpInformation; raises MullvadVpnError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = MullvadVpnHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
