...
from projectname_sdk import MullvadVpnSDK
from projectname_sdk.core.spec import MullvadVpnSpec
from projectname_sdk.core.result import MullvadVpnResult
from projectname_sdk.core.response import MullvadVpnResponse
from projectname_sdk.core.operation import MullvadVpnOperation
from projectname_sdk.core.error import MullvadVpnError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MullvadVpnBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return MullvadVpnError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = MullvadVpnSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = MullvadVpnSDK.test(None, None)
        ...
        class TestInitFeature(MullvadVpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MullvadVpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MullvadVpnSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MullvadVpnSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MullvadVpnSDK.test(None, setup_opts)
