...
class MullvadVpnNetsimFeature extends MullvadVpnBaseFeature
{
    ...
    private function _simulate(MullvadVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MullvadVpnContext $ctx, array $applied): void
    {
        $client = $this->client;
