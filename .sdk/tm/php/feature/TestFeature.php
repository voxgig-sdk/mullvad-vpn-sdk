...
// MullvadVpn SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MullvadVpnTestFeature extends MullvadVpnBaseFeature
{
    ...
    public function init(MullvadVpnContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MullvadVpnContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MullvadVpnParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MullvadVpnContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MullvadVpnContext $ctx, $op, $args): array
    {
