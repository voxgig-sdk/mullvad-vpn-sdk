...
// MullvadVpn SDK ratelimit feature
...
class MullvadVpnRatelimitFeature extends MullvadVpnBaseFeature
{
    ...
    private function _acquire(MullvadVpnContext $ctx): void
    {
    ...
    private function _track(MullvadVpnContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
