...
// MullvadVpn SDK utility: fetcher

class MullvadVpnFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MullvadVpnSDK/1.0)';
    ...
    public static function call(MullvadVpnContext $ctx, string $fullurl, array $fetchdef): array
    {
