...
describe("IpInformationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MULLVADVPN_TEST_IP_INFORMATION_ENTID JSON to run live")
      return
    end
...
function ip_information_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MULLVADVPN_TEST_IP_INFORMATION_ENTID")
  ...
  if env["MULLVADVPN_TEST_LIVE"] == "TRUE" then
