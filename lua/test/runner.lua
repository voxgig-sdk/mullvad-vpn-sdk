...
function runner.env_override(m)
  local live = runner.getenv("MULLVAD_VPN_TEST_LIVE")
  local override = runner.getenv("MULLVAD_VPN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MULLVAD_VPN_TEST_EXPLAIN")
