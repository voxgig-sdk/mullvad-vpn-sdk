# MullvadVpn SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MullvadVpnSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MullvadVpnSDK(...) and MullvadVpnSDK.test(...) become
#      MullvadVpnSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mullvadvpn_sdk"
_SDK_CLASS = "MullvadVpnSDK"
