...
class MullvadVpnTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MullvadVpnTestRunner.getenv("MULLVADVPN_TEST_LIVE")
        override = MullvadVpnTestRunner.getenv("MULLVADVPN_TEST_OVERRIDE")
        ...
        explain = MullvadVpnTestRunner.getenv("MULLVADVPN_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["MULLVADVPN_TEST_EXPLAIN"] = explain
