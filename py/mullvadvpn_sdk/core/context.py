...
from mullvadvpn_sdk.core.control import MullvadVpnControl
...
from mullvadvpn_sdk.core.helpers import get_ctx_prop, to_map
...
class MullvadVpnContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, MullvadVpnSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MullvadVpnResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MullvadVpnResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MullvadVpnError(code, msg, self)
