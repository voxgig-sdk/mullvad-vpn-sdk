...
from mullvadvpn_sdk.utility import register

# Load features
from mullvadvpn_sdk.feature.base_feature import MullvadVpnBaseFeature
from mullvadvpn_sdk.features import _make_feature
...
class MullvadVpnSDK:
    ...
    def get_utility(self):
        return MullvadVpnUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MullvadVpnSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def IpInformation(self, data=None) -> "IpInformationEntity":
        ...
        from mullvadvpn_sdk.entity.ip_information_entity import IpInformationEntity
        return IpInformationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MullvadVpnSDK":
        if sdkopts is None:
            sdkopts = {}
