...
class MullvadVpnRbacFeature extends MullvadVpnBaseFeature
{
    ...
    private function _required(MullvadVpnContext $ctx): ?string
    {
    ...
    private function _reject(MullvadVpnContext $ctx, string $required): void
    {
    ...
    private function _track(MullvadVpnContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
