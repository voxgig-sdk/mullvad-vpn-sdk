...
// MullvadVpn SDK timeout feature
...
class MullvadVpnTimeoutFeature extends MullvadVpnBaseFeature
{
    ...
    private function _with_timeout(MullvadVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MullvadVpnContext $_ctx, float $ms): void
    {
        $client = $this->client;
