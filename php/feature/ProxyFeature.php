...
class MullvadVpnProxyFeature extends MullvadVpnBaseFeature
{
    ...
    public function init(MullvadVpnContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MullvadVpnContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
