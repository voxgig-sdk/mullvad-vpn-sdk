...
// MullvadVpn SDK clienttrack feature
...
class MullvadVpnClienttrackFeature extends MullvadVpnBaseFeature
{
    ...
    public function PostConstruct(MullvadVpnContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MullvadVpn-SDK';
