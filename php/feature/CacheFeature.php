...
class MullvadVpnCacheFeature extends MullvadVpnBaseFeature
{
    ...
    private function _through(MullvadVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
