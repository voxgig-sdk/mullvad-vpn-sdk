...
// MullvadVpn SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MullvadVpnSDK::test)
...
{
    private const SDK_CLASS = 'MullvadVpnSDK';
    ...
    private const SDK_BASE = 'mullvadvpn_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mullvadvpn_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
