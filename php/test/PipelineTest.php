...
{
    private static function utility(): MullvadVpnUtility
    {
        return new MullvadVpnUtility();
    }
    ...
    private static function ctx(array $over = []): MullvadVpnContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MullvadVpnContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MullvadVpnOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MullvadVpnError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MullvadVpnOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MullvadVpnMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MullvadVpnOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MullvadVpnMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MullvadVpnOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MullvadVpnMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MullvadVpnSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MullvadVpnMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MullvadVpnResponse([]),
            'result' => new MullvadVpnResult([]),
        ]);
        [, $err] = MullvadVpnMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MullvadVpnSpec([]),
            'response' => null,
            'result' => new MullvadVpnResult([]),
        ]);
        [, $err] = MullvadVpnMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MullvadVpnSpec(['step' => 's']),
            'response' => new MullvadVpnResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MullvadVpnResult([]),
        ]);
        [, $err] = MullvadVpnMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MullvadVpnSpec(['step' => 's']),
            'response' => new MullvadVpnResponse(self::resp(200, ['v' => 1])),
            'result' => new MullvadVpnResult([]),
        ]);
        [, $err] = MullvadVpnMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MullvadVpnSpec(['step' => 's']),
            'response' => new MullvadVpnResponse(self::resp(200, ['v' => 2])),
            'result' => new MullvadVpnResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MullvadVpnMakeResponse::call($ctx);
    ...
    {
        $preset = new MullvadVpnResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MullvadVpnSpec([]),
            'response' => new MullvadVpnResponse([]),
            'result' => new MullvadVpnResult([]),
        ...
        [$got, $err] = MullvadVpnMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MullvadVpnResult([])]);
        [, $err] = MullvadVpnMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MullvadVpnSpec([]), 'result' => null]);
        [, $err] = MullvadVpnMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MullvadVpnSpec(['step' => 's']),
            'result' => new MullvadVpnResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MullvadVpnOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MullvadVpnMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MullvadVpnSpec(['step' => 's']),
            'result' => new MullvadVpnResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MullvadVpnOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MullvadVpnMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MullvadVpnResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MullvadVpnSpec([]),
            'result' => new MullvadVpnResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MullvadVpnMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MullvadVpnMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MullvadVpnError('boom', 'boom');
        $utility->fetcher = function (MullvadVpnContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MullvadVpnSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MullvadVpnMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MullvadVpnContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MullvadVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MullvadVpnResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MullvadVpnMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MullvadVpnContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MullvadVpnSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MullvadVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MullvadVpnResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MullvadVpnSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MullvadVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MullvadVpnMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MullvadVpnMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MullvadVpnResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MullvadVpnDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MullvadVpnResult(['ok' => false])]);
        $this->expectException(MullvadVpnError::class);
        MullvadVpnDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MullvadVpnResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MullvadVpnMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MullvadVpnMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MullvadVpnBaseFeature();
        $b = new MullvadVpnBaseFeature();
        MullvadVpnFeatureAdd::call($ctx, $a);
        MullvadVpnFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MullvadVpnBaseFeature
    {
        $f = new MullvadVpnBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MullvadVpnFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MullvadVpnContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MullvadVpnSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MullvadVpnPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MullvadVpnPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MullvadVpnResponse(['headers' => null]),
            'result' => new MullvadVpnResult([]),
        ]);
        MullvadVpnResultHeaders::call($ctx);
