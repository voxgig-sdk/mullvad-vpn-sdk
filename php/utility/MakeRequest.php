...
// MullvadVpn SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MullvadVpnMakeRequest
{
    public static function call(MullvadVpnContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MullvadVpnResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MullvadVpnResponse($fetched);
        } else {
