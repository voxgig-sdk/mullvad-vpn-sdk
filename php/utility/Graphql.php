...
// MullvadVpn SDK utility: graphql
//
...
class MullvadVpnGraphql
{
    ...
    // equivalent.
    public static function body(MullvadVpnContext $ctx): mixed
    {
    ...
    public static function errors(MullvadVpnContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
