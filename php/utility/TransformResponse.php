...
// MullvadVpn SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MullvadVpnTransformResponse
{
    public static function call(MullvadVpnContext $ctx): mixed
    {
        ...
        $transform = MullvadVpnHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
