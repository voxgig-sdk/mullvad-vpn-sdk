// Command MullvadVpn-mcp is an MCP server exposing the MullvadVpn
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MullvadVpn_list  — list records of an entity
//	MullvadVpn_load  — load a single record of an entity
//
