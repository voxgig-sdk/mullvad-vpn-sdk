...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ip_information"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MullvadVpnSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mullvad-vpn_list",
		Description: "List records from MullvadVpn. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mullvad-vpn_load",
		Description: "Load a single record from MullvadVpn. " +
...
func runOp(client *sdk.MullvadVpnSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MullvadVpnSDK, name string) (sdk.MullvadVpnEntity, error) {
